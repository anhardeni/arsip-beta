                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['isAdmin','isStaff'])): ?>
                            <li><a href="<?php echo e(route('pfpd.index')); ?>">Set PFPD</a></li>
                            ...
                            <li><a href="#">Set Nama Jabatan</a></li>
                            <?php endif; ?>
                        </ul>
                    </li>
                </ul>
...
<?php /**PATH D:\laragon\www\arsip-bete\resources\views/layouts/global.blade.php ENDPATH**/ ?>